...
Revision ID: 3eb4af15b5ea
Revises: 
Create Date: 2024-04-05 12:00:56.013750
...
def upgrade():
    ...
    sa.Column('organisation_uuid', sa.UUID(), nullable=True),
    sa.Column('logo_url', sa.String(), nullable=True),
    sa.Column('is_deleted', sa.Boolean(), nullable=True),
    sa.Column('is_active', sa.Boolean(), nullable=True),
    sa.Column('create_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('brand_uuid', sa.UUID(), nullable=True),
    sa.Column('logo_url', sa.String(), nullable=True),
    sa.Column('is_deleted', sa.Boolean(), nullable=True),
    sa.Column('is_active', sa.Boolean(), nullable=True),
    sa.Column('create_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('uuid', sa.UUID(), nullable=False),
    sa.Column('uploads_uuid', sa.UUID(), nullable=True),
    ...
    sa.Column('is_deleted', sa.Boolean(), nullable=True),
    sa.Column('user_uuid', sa.UUID(), nullable=True),
    sa.Column('post_uuid', sa.UUID(), nullable=True),
    sa.Column('create_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.Column('created_by', sa.UUID(), nullable=True),
    sa.Column('updated_by', sa.UUID(), nullable=True),
